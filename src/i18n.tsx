...
export const en = {
  ...
  'scan.deeperDescription': 'Three rounds across six destinations. Useful for load-balanced or changing routes; takes up to ~25 seconds.',
...
export const de: Record<TranslationKey, Message> = {
  ...
  'scan.deeperDescription': 'Drei Durchläufe über sechs Ziele. Hilfreich bei Lastverteilung oder wechselnden Routen; dauert bis zu etwa 25 Sekunden.',
